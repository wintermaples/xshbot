...
class RainEventStartScheduler(threading.Thread):
    ...
    def __init__(self):
        ...
        self.start_date_time = datetime.datetime(2018, 3, 3, 20, 0, 0)
...
class RainEventScheduler():
    ...
    def __init__(self):
        self.start_date_time = datetime.datetime(2018, 3, 3, 20, 0, 20)
    ...
    async def task(self, client):
        ...
        while not client.is_closed:
            if datetime.datetime.now() > self.start_date_time:
                ...
                newUserWallets = [wallet for wallet in wallets if not wallet['name'] in self.excluded_users and wallet['balance'] < 0.001]
